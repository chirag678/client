...
const headers = [
  ...
  { label: 'Docs', href: 'https://docs.google.com/document/d/1rafYJwM2TWJVFifehBzTQOE5zmkxsGHpovpbPVMuz2o/edit?usp=sharing', 
    window.open('https://docs.google.com/document/d/1rafYJwM2TWJVFifehBzTQOE5zmkxsGHpovpbPVMuz2o/edit?usp=sharing', '_blank') },
  { label: 'Community', href: 'https://twitter.com/DRexProtocol', 
    window.open('https://twitter.com/DRexProtocol', '_blank'); }
]
